...
with(this){return _c('p',[_c('em',[_v("{ list here sources of all reused/adapted ideas, code, documentation, and third-party libraries -- include links to the original source as well }")]),_v("\nThis project is based on the AddressBook-Level3 project created by the "),_c('a',{attrs:{"href":"https://se-education.org"}},[_v("SE-EDU initiative")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("has a need to manage a significant number of employees and potential hires")]),_v(" "),_c('li',[_v("has a need to match potential hires with available job openings")]),_v(" "),_c('li',[_v("has a need to find details about an employee or potential hire quickly")]),_v(" "),_c('li',[_v("has a need to search for employees or potential hires with relevant details")]),_v(" "),_c('li',[_v("forgets commands and requires a list of commands to use the application")]),_v(" "),_c('li',[_v("prefer desktop applications over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("View phone number of my employees/potential hire")]),_v(" "),_c('td',[_v("I can easily contact them if required")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("Insert phone number of my employees/potential hire")]),_v(" "),_c('td',[_v("I can retrieve their phone number if required")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("View email addresses of employees/potential hire")]),_v(" "),_c('td',[_v("I can contact them if its not an emergency")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("Insert phone number of my employees/potential hire")]),_v(" "),_c('td',[_v("I can retrieve their email address if required")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("Delete data through the UI")]),_v(" "),_c('td',[_v("I can delete users who are incorrectly added")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("View address of employees/potential hire")]),_v(" "),_c('td',[_v("I can view the address of the user to decide where to deploy them")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("New user")]),_v(" "),_c('td',[_v("Be shown some basic functions")]),_v(" "),_c('td',[_v("I can learn the basic functions of the product")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("New user")]),_v(" "),_c('td',[_v("View the user guide easily")]),_v(" "),_c('td',[_v("I can learn more functions of the product whenever I want")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("New user")]),_v(" "),_c('td',[_v("Purge the sample data in the tutorial")]),_v(" "),_c('td',[_v("I can input my own data to use")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("View the emergency contact details of employees")]),_v(" "),_c('td',[_v("I can quickly respond in case of an emergency")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("Sort the employee information by when their contract will expire")]),_v(" "),_c('td',[_v("I can better plan out when to resign contracts")])]),_v(" "),_c('tr',[_c('td',[_c('em',[_v("{More to be added}")])]),_v(" "),_c('td'),_v(" "),_c('td'),_v(" "),_c('td')])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("StaffSync")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons")])]),_v(" "),_c('li',[_c('p',[_v("StaffSync shows a list of persons")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific person in the list")])]),_v(" "),_c('li',[_c('p',[_v("StaffSync deletes the person")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. StaffSync shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add an employee.")])]),_v(" "),_c('li',[_c('p',[_v("StaffSync saves the employee's information.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true},[_v("* 1a1. StaffSync shows an error message.\n\nUse case resumes at step 1.\n")])])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true},[_v("*1b1. StaffSync saves the potential hire's information.\n\nUse case ends.\n")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to find based on name.")]),_v(" "),_c('li',[_v("StaffSync displays a list of people who have the name.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('pre',[_c('code',{pre:true},[_v("*1b1. The list is empty.\n\nUse case ends.\n")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Ask for help")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests for help.")]),_v(" "),_c('li',[_v("StaffSync gives a list of commands.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to exit the program.")]),_v(" "),_c('li',[_v("StaffSync closes.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" on either 32-bit or 64-bit systems as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should be able to hold up and deal with up to 1000 persons without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("A user should be able to run the software without the need to install libraries or other dependencies. They should only need Java to run the program and the program should be self contained.")]),_v(" "),_c('li',[_v("The software should be resizable and by default, be of a size that is usable on a 1920x1080 screen.")]),_v(" "),_c('li',[_v("The software should be backward compatible for version changes and previous saved data should be able to be loaded without any issues.")]),_v(" "),_c('li',[_v("Our software should have an "),_c('em',[_v("MVP")]),_v(" by the end of v1.3, around the end of week 9.")]),_v(" "),_c('li',[_v("Our software should have an "),_c('em',[_v("Alpha Release")]),_v(" by the end of v1.4, around the end of week 10.")]),_v(" "),_c('li',[_v("Our software should have a "),_c('em',[_v("Release Candidate")]),_v(" by the end of v1.5, around the end of week 11.")]),_v(" "),_c('li',[_v("Our software should have a "),_c('em',[_v("Public Release")]),_v(" by the end of v1.6, around the end of week 12.")]),_v(" "),_c('li',[_v("Our software will NOT handle any security or privacy related to data inserted into the software. It is the user's responsibility to ensure that the data is not sensitive or private and that it will not be leaked.")]),_v(" "),_c('li',[_v("Our software should not have any memory leaks and should not consume more memory than necessary.")]),_v(" "),_c('li',[_v("Our software should not crash with any user input.")]),_v(" "),_c('li',[_v("A user should not need to use their mouse for over 50% of the time when using the software.")]),_v(" "),_c('li',[_v("Our software should be usable 100% of the time without an internet connection.")]),_v(" "),_c('li',[_v("Our software should be able to process all commands under 1 second within our limitations above.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Wed, 9 Oct 2024, 21:05:20 GMT+8]")])])])}
}];
